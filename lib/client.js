		...
		function FlowBoard({ team, onNavigate }) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsxs)("header", {
					...
					children: [(0, react_jsx_runtime.jsx)(RequirementRail, {
						team,
						focusedTaskId,
						related,
