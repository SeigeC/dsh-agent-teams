	...
	factory: (require) => {
		...
		* (historical session review). */
		...
		var ActivityPanel_module_css_default = {
			...
			"memberCardStatus": "qZToFW_memberCardStatus",
			"sectionHint": "qZToFW_sectionHint",
			"kanbanColumnHead": "qZToFW_kanbanColumnHead",
			"closeButton": "qZToFW_closeButton",
			"archivedWrap": "qZToFW_archivedWrap",
			"memberRole": "qZToFW_memberRole",
			"memberCardInitial": "qZToFW_memberCardInitial",
			...
			"taskCardRoute": "qZToFW_taskCardRoute",
			"kanbanColumns": "qZToFW_kanbanColumns",
			"memberCardInfo": "qZToFW_memberCardInfo",
			"taskCard": "qZToFW_taskCard",
			...
			"taskCardSubject": "qZToFW_taskCardSubject",
			...
			"memberCardAvatar": "qZToFW_memberCardAvatar",
			"memberCardName": "qZToFW_memberCardName",
			...
			"kanbanColumn": "qZToFW_kanbanColumn",
			"taskCardId": "qZToFW_taskCardId",
			"badge": "qZToFW_badge",
			"panelHead": "qZToFW_panelHead",
			"taskNodeHead": "qZToFW_taskNodeHead",
			"taskStart": "qZToFW_taskStart",
			"kanbanCount": "qZToFW_kanbanCount",
			"team": "qZToFW_team",
			...
			"viewTabs": "qZToFW_viewTabs",
			"assignmentLine": "qZToFW_assignmentLine",
			"memberCard": "qZToFW_memberCard",
			...
			"boardHead": "qZToFW_boardHead",
			"memberStrip": "qZToFW_memberStrip",
			"memberCount": "qZToFW_memberCount",
			"taskBadge": "qZToFW_taskBadge",
			"taskCardDeps": "qZToFW_taskCardDeps"
		};
		//#endregion
		...
		* claimed/pending/failed/cancelled keep their own labels and colors. */
		...
		function TaskCard({ task, tasks }) {
			const tone = taskTone(task.state, task.status);
			return (0, react_jsx_runtime.jsxs)("div", {
				className: ActivityPanel_module_css_default.taskCard,
				"data-state": tone,
				title: task.subject,
				children: [
					(0, react_jsx_runtime.jsxs)("span", {
						className: ActivityPanel_module_css_default.taskCardHead,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: ActivityPanel_module_css_default.taskCardId,
							children: task.id
						}), (0, react_jsx_runtime.jsx)("span", {
							className: ActivityPanel_module_css_default.taskBadge,
							"data-state": tone,
					...
					(0, react_jsx_runtime.jsx)("span", {
						className: ActivityPanel_module_css_default.taskCardSubject,
						children: task.subject
					}),
					(0, react_jsx_runtime.jsxs)("span", {
						className: ActivityPanel_module_css_default.taskCardRoute,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: ActivityPanel_module_css_default.taskOwner,
							children: task.assignee || "待认领"
						}), task.dependencies.length > 0 && (0, react_jsx_runtime.jsxs)("span", {
							className: ActivityPanel_module_css_default.taskCardDeps,
							children: ["依赖 ", dependencyLabel(task, tasks)]
						})]
					})
				]
		...
		*/
		function KanbanBoard({ team, onNavigate }) {
			const completedCount = team.tasks.filter((task) => task.status === "completed").length;
			return (0, react_jsx_runtime.jsxs)("section", {
				className: ActivityPanel_module_css_default.board,
				"data-board": true,
				"data-team-id": team.teamId,
				children: [
					(0, react_jsx_runtime.jsxs)("header", {
						className: ActivityPanel_module_css_default.boardHead,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: ActivityPanel_module_css_default.teamName,
							title: team.name,
							children: team.name
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: team.members.map((member) => (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: ActivityPanel_module_css_default.memberCard,
							"data-activity": member.activity,
							onClick: () => {
								if (member.id !== "") onNavigate(member.id);
							},
							...
							children: [
								(0, react_jsx_runtime.jsx)("span", {
									className: ActivityPanel_module_css_default.memberCardAvatar,
									"data-activity": member.activity,
									children: memberArtUrl(member.name, member.role) !== null ? (0, react_jsx_runtime.jsx)("img", {
										className: ActivityPanel_module_css_default.memberArt,
										src: memberArtUrl(member.name, member.role) ?? "",
										...
										className: ActivityPanel_module_css_default.memberCardInitial,
										style: { background: accentOf(member.id) },
										children: memberInitial(member.name)
									})
								}),
								(0, react_jsx_runtime.jsxs)("span", {
									className: ActivityPanel_module_css_default.memberCardInfo,
									children: [(0, react_jsx_runtime.jsx)("span", {
										className: ActivityPanel_module_css_default.memberCardName,
										children: member.name
									}), (0, react_jsx_runtime.jsx)("span", {
										className: ActivityPanel_module_css_default.memberCardStatus,
										"data-activity": member.activity,
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: ActivityPanel_module_css_default.kanbanColumns,
						children: BOARD_COLUMNS.map((column) => {
							const tasks = team.tasks.filter((task) => column.match(task.status));
							return (0, react_jsx_runtime.jsxs)("div", {
								className: ActivityPanel_module_css_default.kanbanColumn,
								"data-column": column.key,
								children: [(0, react_jsx_runtime.jsxs)("header", {
									className: ActivityPanel_module_css_default.kanbanColumnHead,
									"data-state": column.tone,
									children: [(0, react_jsx_runtime.jsx)("span", { children: column.label }), (0, react_jsx_runtime.jsx)("span", {
										className: ActivityPanel_module_css_default.kanbanCount,
										children: tasks.length
									})]
								}), (0, react_jsx_runtime.jsxs)("div", {
									className: ActivityPanel_module_css_default.kanbanColumnBody,
		...
		* captain-only recovery views. */
		function ActivityPanel({ sessionsList, openSession }) {
			...
			const [view, setView] = (0, react.useState)("delegation");
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [!expanded && (0, react_jsx_runtime.jsx)(CollapsedBadge, {
				...
				children: [(0, react_jsx_runtime.jsxs)("header", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsxs)("span", {
							className: ActivityPanel_module_css_default.viewTabs,
							role: "tablist",
							"aria-label": "面板视图",
							children: [(0, react_jsx_runtime.jsx)("button", {
								...
								className: ActivityPanel_module_css_default.viewTab,
								onClick: () => {
									setView("delegation");
								},
								children: "派工关系"
					...
					children: visibleCount === 0 ? (0, react_jsx_runtime.jsx)("span", {
						className: ActivityPanel_module_css_default.emptyHint,
						children: "暂无团队活动"
					}) : view === "board" ? (0, react_jsx_runtime.jsx)("div", {
						className: ActivityPanel_module_css_default.boards,
