window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* captain-only recovery views. */
		...
		const css = ".HJsC_W_board{flex-direction:column;gap:10px;display:flex}.HJsC_W_boardHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.HJsC_W_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.HJsC_W_teamStats{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:10px;font-size:10.5px;line-height:15px;display:inline-flex}.HJsC_W_flowArea{min-width:0;position:relative}.HJsC_W_flowSvg{pointer-events:none;width:100%;height:100%;position:absolute;inset:0;overflow:visible}.HJsC_W_edgePath{fill:none;stroke:var(--dsw-alias-border-l3);stroke-width:1.5px;transition:opacity .12s,stroke .12s,stroke-width .12s}.HJsC_W_edgePath[data-hot=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:2.5px}.HJsC_W_edgePath[data-dimmed=true]{opacity:.12}.HJsC_W_edgeArrow{fill:var(--dsw-alias-border-l3)}.HJsC_W_edgeLabel{pointer-events:auto;cursor:pointer;transition:opacity .12s}.HJsC_W_edgeLabelBg{fill:var(--dsw-alias-bg-base);stroke:var(--dsw-alias-border-l2);stroke-width:1px}.HJsC_W_edgeLabelText{fill:var(--dsw-alias-label-secondary);font-size:10px;font-weight:600}.HJsC_W_edgeLabel[data-hot=true] .HJsC_W_edgeLabelBg{fill:var(--dsw-alias-state-business-tertiary);stroke:var(--dsw-alias-state-business-primary)}.HJsC_W_edgeLabel[data-hot=true] .HJsC_W_edgeLabelText{fill:var(--dsw-alias-state-business-primary)}.HJsC_W_edgeLabel[data-dimmed=true]{opacity:.15}.HJsC_W_workerGrid{flex-wrap:wrap;gap:12px;display:flex;position:relative}.HJsC_W_workerNode{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:10px;flex-direction:column;gap:6px;width:172px;min-width:0;padding:10px;transition:opacity .12s,border-color .12s,box-shadow .12s;display:flex}.HJsC_W_workerNode[data-hot=true]{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 22%, transparent)}.HJsC_W_workerNode[data-dimmed=true]{opacity:.35}.HJsC_W_workerHead{width:100%;min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:7px;padding:0;display:flex}.HJsC_W_workerAvatar{border-radius:50%;flex:none;justify-content:center;align-items:center;width:30px;height:30px;display:inline-flex;position:relative}.HJsC_W_workerArt{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);object-fit:cover;background:var(--dsw-alias-bg-layer-1);border-radius:50%;width:28px;height:28px}.HJsC_W_workerInitial{width:28px;height:28px;color:var(--dsw-alias-label-primary-foreground);border-radius:50%;justify-content:center;align-items:center;font-size:12px;font-weight:600;line-height:28px;display:inline-flex}.HJsC_W_workerInfo{flex-direction:column;flex:auto;min-width:0;display:flex}.HJsC_W_workerName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:17px;overflow:hidden}.HJsC_W_workerRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.HJsC_W_workerDot{flex:none;align-items:center;display:inline-flex}.HJsC_W_workerStatus{color:var(--dsw-alias-label-tertiary);font-size:10.5px;line-height:15px}.HJsC_W_workerStatus[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.HJsC_W_workerTasks{flex-direction:column;gap:4px;min-height:20px;display:flex}.HJsC_W_taskChip{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-left:3px solid var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-1);width:100%;min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;border-radius:8px;justify-content:space-between;align-items:center;gap:6px;padding:4px 7px;transition:opacity .12s,border-color .12s;display:flex}.HJsC_W_taskChip[data-state=running]{border-left-color:var(--dsw-alias-state-business-primary)}.HJsC_W_taskChip[data-state=completed]{border-left-color:var(--dsw-alias-state-success-primary)}.HJsC_W_taskChip[data-state=failed]{border-left-color:var(--dsw-alias-state-error-primary)}.HJsC_W_taskChip[data-state=claimed]{border-left-color:var(--dsw-alias-state-warn-primary)}.HJsC_W_taskChip:hover{border-color:var(--dsw-alias-state-business-primary)}.HJsC_W_taskChip[data-dimmed=true]{opacity:.35}.HJsC_W_taskChipId{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;font-weight:700;overflow:hidden}.HJsC_W_unassignedBar{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-wrap:wrap;align-items:center;gap:6px;padding:8px 10px;display:flex}.HJsC_W_unassignedLabel{color:var(--dsw-alias-label-tertiary);font-size:10.5px;font-weight:600;line-height:15px}.HJsC_W_unassignedBar .HJsC_W_taskChip{width:auto}.HJsC_W_taskEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 2px;font-size:10px}.HJsC_W_unreadPill{box-sizing:border-box;background:var(--dsw-alias-state-business-primary);min-width:16px;height:16px;color:var(--dsw-alias-label-primary-foreground);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;font-size:9.5px;font-weight:600;line-height:16px;display:inline-flex}@keyframes HJsC_W_agentTeamsBreathe{0%,to{box-shadow:0 0 0 0 color-mix(in srgb, var(--dsw-alias-state-business-primary) 0%, transparent)}50%{box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 28%, transparent)}}";
		...
		var BoardView_module_css_default = {
			...
			"workerAvatar": "HJsC_W_workerAvatar",
			"workerDot": "HJsC_W_workerDot",
			"teamStats": "HJsC_W_teamStats",
			"edgeLabel": "HJsC_W_edgeLabel",
			"teamName": "HJsC_W_teamName",
			"taskChipId": "HJsC_W_taskChipId",
			"workerTasks": "HJsC_W_workerTasks",
			"board": "HJsC_W_board",
			"taskChip": "HJsC_W_taskChip",
			"workerStatus": "HJsC_W_workerStatus",
			"workerArt": "HJsC_W_workerArt",
			"unassignedBar": "HJsC_W_unassignedBar",
			"unassignedLabel": "HJsC_W_unassignedLabel",
			"edgeArrow": "HJsC_W_edgeArrow",
			"boardHead": "HJsC_W_boardHead",
			"agentTeamsBreathe": "HJsC_W_agentTeamsBreathe",
			"workerInfo": "HJsC_W_workerInfo",
			"workerNode": "HJsC_W_workerNode",
			"taskEmpty": "HJsC_W_taskEmpty",
			"unreadPill": "HJsC_W_unreadPill",
			"workerName": "HJsC_W_workerName",
			"edgePath": "HJsC_W_edgePath",
			"workerInitial": "HJsC_W_workerInitial",
			"workerHead": "HJsC_W_workerHead",
...
`;
		...
		* unassigned tasks stay inside the node / pool instead of becoming edges. */
		...
		function WorkerNode({ member, tasks, focusedRelated, onFocus, onBlur, onNavigate }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: BoardView_module_css_default.workerNode,
				...
				children: [
					(0, react_jsx_runtime.jsxs)("button", {
						type: "button",
						className: BoardView_module_css_default.workerHead,
						onClick: () => {
							if (member.id !== "") onNavigate(member.id);
						},
						...
						children: [
							(0, react_jsx_runtime.jsx)("span", {
								className: BoardView_module_css_default.workerAvatar,
								"data-activity": member.activity,
								children: memberArtUrl(member.name, member.role) !== null ? (0, react_jsx_runtime.jsx)("img", {
									className: BoardView_module_css_default.workerArt,
									src: memberArtUrl(member.name, member.role) ?? "",
									alt: "",
									"aria-hidden": true
								}) : (0, react_jsx_runtime.jsx)("span", {
									className: BoardView_module_css_default.workerInitial,
									style: { background: accentOf(member.id) },
									children: memberInitial(member.name)
								})
							}),
							(0, react_jsx_runtime.jsxs)("span", {
								className: BoardView_module_css_default.workerInfo,
								children: [(0, react_jsx_runtime.jsx)("span", {
							...
							(0, react_jsx_runtime.jsx)("span", {
								className: BoardView_module_css_default.workerDot,
								children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, { state: memberDotState(member, tasks) })
							}),
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: BoardView_module_css_default.workerStatus,
						"data-activity": member.activity,
						children: memberStateLabel(member, tasks)
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						className: BoardView_module_css_default.workerTasks,
						children: [owned.length === 0 && (0, react_jsx_runtime.jsx)("span", {
							className: BoardView_module_css_default.taskEmpty,
							children: "暂无任务"
						}), owned.map((task) => (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: BoardView_module_css_default.taskChip,
							"data-state": taskTone(task.state, task.status),
							...
							onBlur,
							children: [(0, react_jsx_runtime.jsx)("span", {
								className: BoardView_module_css_default.taskChipId,
								children: task.id
							}), (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		function FlowBoard({ team, onNavigate }) {
			...
			const [nodeRects, setNodeRects] = (0, react.useState)(/* @__PURE__ */ new Map());
			const [containerSize, setContainerSize] = (0, react.useState)({
				width: 0,
				height: 0
			});
			const edges = (0, react.useMemo)(() => buildEdges(team.tasks), [team.tasks]);
			const related = (0, react.useMemo)(() => focusedTaskId === null ? null : relatedTaskIds(focusedTaskId, team.tasks), [focusedTaskId, team.tasks]);
			(0, react.useMemo)(() => {
				if (related === null) return null;
				const names = /* @__PURE__ */ new Set();
				for (const task of team.tasks) if (related.has(task.id) && task.assignee !== "") names.add(task.assignee);
				return names;
			}, [related, team.tasks]);
			const completedCount = team.tasks.filter((task) => task.status === "completed").length;
			...
			(0, react.useLayoutEffect)(() => {
				const update = () => {
					...
					for (const el of container.querySelectorAll("[data-worker-node]")) {
						...
						if (name !== void 0) map.set(name, el.getBoundingClientRect());
					}
					setNodeRects(map);
					setContainerSize({
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					unassigned.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: BoardView_module_css_default.unassignedBar,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: BoardView_module_css_default.unassignedLabel,
							children: "待认领"
						}), unassigned.map((task) => (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: BoardView_module_css_default.taskChip,
							"data-state": taskTone(task.state, task.status),
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("svg", {
							className: BoardView_module_css_default.flowSvg,
							...
							children: [(0, react_jsx_runtime.jsx)("defs", { children: (0, react_jsx_runtime.jsx)("marker", {
								...
								children: (0, react_jsx_runtime.jsx)("path", {
									...
									className: BoardView_module_css_default.edgeArrow
								})
							}) }), edges.map((edge) => {
								const from = nodeRects.get(edge.from);
								const to = nodeRects.get(edge.to);
								if (from === void 0 || to === void 0 || containerRect === null) return null;
								...
								return (0, react_jsx_runtime.jsxs)("g", { children: [(0, react_jsx_runtime.jsx)("path", {
									className: BoardView_module_css_default.edgePath,
									"data-dimmed": dimmed,
									"data-hot": hot,
									d: path,
									markerEnd: `url(#at-flow-arrow-${team.teamId})`
								}), (0, react_jsx_runtime.jsxs)("g", {
									className: BoardView_module_css_default.edgeLabel,
									"data-dimmed": dimmed,
									"data-hot": hot,
									transform: `translate(${(x1 + x2) / 2} ${midY})`,
									onMouseEnter: () => {
										setFocusedTaskId(edge.task.id);
									},
									onMouseLeave: () => {
										setFocusedTaskId(null);
									},
									...
									children: [
										(0, react_jsx_runtime.jsx)("rect", {
											className: BoardView_module_css_default.edgeLabelBg,
											width: labelWidth,
											height: 20,
											rx: 10
										}),
										(0, react_jsx_runtime.jsx)("text", {
											className: BoardView_module_css_default.edgeLabelText,
											x: labelWidth / 2,
											y: 14,
											textAnchor: "middle",
											children: edge.task.id
										}),
										(0, react_jsx_runtime.jsx)("title", { children: `${edge.task.id} ${edge.task.subject}：${edge.from} → ${edge.to}` })
									]
								})] }, edge.id);
							})]
						}), (0, react_jsx_runtime.jsx)("div", {
							className: BoardView_module_css_default.workerGrid,
							children: team.members.map((member) => (0, react_jsx_runtime.jsx)(WorkerNode, {
								member,
								tasks: team.tasks,
