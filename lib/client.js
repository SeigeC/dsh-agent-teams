...
`;
		...
		*/
		function BoardOverlay({ sessionsList, openSession }) {
			...
			return (0, react_dom.createPortal)((0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: visibleTeams.map((team) => (0, react_jsx_runtime.jsx)(KanbanBoard, {
				team,
				onNavigate: (id) => {
					openSession(id);
				}
