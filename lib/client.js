					...
					children: [
						...
						visible.length > 0 && (0, react_jsx_runtime.jsx)("div", {
							...
							children: visible.map((task, index) => (0, react_jsx_runtime.jsx)("span", {
								...
								style: visible.length > 1 ? { transform: `rotate(${index * angleStep}deg) translate(38px) rotate(${-index * angleStep}deg)` } : void 0,
				...
				children: [
					...
					unassigned.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							children: "待认领"
						}), unassigned.map((task) => (0, react_jsx_runtime.jsx)(TaskOrb, {
							task,
							tasks: team.tasks,
							dimmed: related !== null && !related.has(task.id),
