window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* captain-only recovery views. */
		...
		const css = ".HJsC_W_board{flex-direction:column;gap:10px;display:flex}.HJsC_W_boardHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.HJsC_W_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.HJsC_W_teamStats{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:10px;font-size:10.5px;line-height:15px;display:inline-flex}.HJsC_W_memberStrip{flex-wrap:wrap;gap:6px;display:flex}.HJsC_W_memberCard{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;border-radius:10px;align-items:center;gap:7px;padding:4px 9px 4px 4px;transition:border-color .12s,background-color .12s;display:inline-flex}.HJsC_W_memberCard:hover{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 45%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-layer-1))}.HJsC_W_memberCard[data-activity=working]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 65%, transparent);animation:4.2s ease-in-out infinite HJsC_W_agentTeamsBreathe}.HJsC_W_memberCardAvatar{border-radius:50%;flex:none;justify-content:center;align-items:center;width:26px;height:26px;display:inline-flex;position:relative}.HJsC_W_memberCardAvatar .HJsC_W_memberArt{width:26px;height:26px}.HJsC_W_memberCardInitial{width:26px;height:26px;color:var(--dsw-alias-label-primary-foreground);border-radius:50%;justify-content:center;align-items:center;font-size:11px;font-weight:600;line-height:26px;display:inline-flex}.HJsC_W_memberCardInfo{flex-direction:column;min-width:0;display:flex}.HJsC_W_memberCardName{max-width:90px;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}.HJsC_W_memberCardStatus{max-width:110px;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.HJsC_W_memberCardStatus[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.HJsC_W_kanbanColumns{overscroll-behavior-x:contain;gap:8px;min-height:96px;padding-bottom:2px;display:flex;overflow-x:auto}.HJsC_W_kanbanColumn{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-markdown-tag) 55%, transparent);border-radius:12px;flex-direction:column;flex:none;width:200px;min-height:96px;display:flex}.HJsC_W_kanbanColumnHead{color:var(--dsw-alias-label-secondary);flex:none;justify-content:space-between;align-items:center;padding:8px 10px;font-size:11px;font-weight:600;line-height:16px;display:flex}.HJsC_W_kanbanColumnHead[data-state=running]{color:var(--dsw-alias-state-business-primary)}.HJsC_W_kanbanColumnHead[data-state=completed]{color:var(--dsw-alias-state-success-primary)}.HJsC_W_kanbanColumnHead[data-state=failed]{color:var(--dsw-alias-state-error-primary)}.HJsC_W_kanbanCount{box-sizing:border-box;background:var(--dsw-alias-markdown-tag);min-width:18px;height:18px;color:var(--dsw-alias-label-tertiary);border-radius:9px;justify-content:center;align-items:center;padding:0 5px;font-size:10px;font-weight:600;line-height:18px;display:inline-flex}.HJsC_W_kanbanColumnBody{flex-direction:column;gap:6px;padding:6px;display:flex}.HJsC_W_taskCard{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-left:3px solid var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);border-radius:9px;flex-direction:column;gap:3px;padding:7px 9px;display:flex}.HJsC_W_taskCard[data-state=running]{border-left-color:var(--dsw-alias-state-business-primary)}.HJsC_W_taskCard[data-state=completed]{border-left-color:var(--dsw-alias-state-success-primary)}.HJsC_W_taskCard[data-state=failed]{border-left-color:var(--dsw-alias-state-error-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 35%, var(--dsw-alias-border-l2))}.HJsC_W_taskCard[data-state=claimed]{border-left-color:var(--dsw-alias-state-warn-primary)}.HJsC_W_taskCardHead{justify-content:space-between;align-items:center;gap:6px;display:flex}.HJsC_W_taskCardId{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:700;overflow:hidden}.HJsC_W_taskBadge{box-sizing:border-box;background:var(--dsw-alias-markdown-tag);height:16px;color:var(--dsw-alias-label-secondary);border-radius:8px;flex:none;align-items:center;padding:0 5px;font-size:9px;font-weight:600;line-height:16px;display:inline-flex}.HJsC_W_taskBadge[data-state=running]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 14%, var(--dsw-alias-markdown-tag));color:var(--dsw-alias-state-business-primary)}.HJsC_W_taskBadge[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 14%, var(--dsw-alias-markdown-tag));color:var(--dsw-alias-state-success-primary)}.HJsC_W_taskBadge[data-state=failed]{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 14%, var(--dsw-alias-markdown-tag));color:var(--dsw-alias-state-error-primary)}.HJsC_W_taskBadge[data-state=cancelled]{background:var(--dsw-alias-markdown-tag);color:var(--dsw-alias-label-tertiary)}.HJsC_W_taskCardSubject{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;line-height:15px;overflow:hidden}.HJsC_W_taskCardRoute{justify-content:space-between;align-items:center;gap:6px;display:flex}.HJsC_W_taskOwner{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.HJsC_W_taskCardDeps{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:9.5px;overflow:hidden}.HJsC_W_taskEmpty{color:var(--dsw-alias-label-tertiary);padding:4px 2px;font-size:10px}.HJsC_W_unreadPill{box-sizing:border-box;background:var(--dsw-alias-state-business-primary);min-width:16px;height:16px;color:var(--dsw-alias-label-primary-foreground);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;font-size:9.5px;font-weight:600;line-height:16px;display:inline-flex}@keyframes HJsC_W_agentTeamsBreathe{0%,to{box-shadow:0 0 0 0 color-mix(in srgb, var(--dsw-alias-state-business-primary) 0%, transparent)}50%{box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 28%, transparent)}}";
